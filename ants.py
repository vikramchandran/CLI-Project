...
class Place(object):
    ...
    def remove_insect(self, insect):
        ...
        """
        if isinstance(insect, QueenAnt) and insect.instance == 0:
            return
        elif insect.is_ant:
            # Phase 6: Special Handling for BodyguardAnt and QueenAnt
            if self.ant is insect and self.ant:
...
class ThrowerAnt(Ant):
    ...
    def nearest_bee(self, hive):
        ...
        while curr_place is not hive:
            if self.min_range <= counter <= self.max_range:
                if curr_place.bees:
...
# END Problem 13
    ...
    def __init__(self ):
        # BEGIN Problem 13
        Ant.__init__(self)
        self.instance = QueenAnt.instance
        QueenAnt.instance += 1
        # END Problem 13
    ...
    def action(self, colony):
        ...
        curr_place = self.place
        while curr_place!= None and curr_place.exit != None:
            if curr_place.exit.ant != None and curr_place.exit.ant not in QueenAnt.lst:
                curr_place.exit.ant.damage *= 2
                QueenAnt.lst.append(curr_place.exit.ant)
            if curr_place.exit.ant != None and curr_place.exit.ant.container == True  and curr_place.exit.ant.ant != None and curr_place.exit.ant.ant not in QueenAnt.lst:
                curr_place.exit.ant.ant.damage *= 2
                QueenAnt.lst.append(curr_place.exit.ant.ant)
